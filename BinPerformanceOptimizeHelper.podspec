...
Pod::Spec.new do |s|
  ...
  s.author             = { "JerryZhang" => "1957299143@qq.com" }
  # Or just: s.author    = "JerryZhang"
  # s.authors            = { "JerryZhang" => "1957299143@qq.com" }
  # s.social_media_url   = "http://twitter.com/JerryZhang"
  ...
  s.source       = { :git => "https://github.com/jerryzhang147/BinPerformanceOptimizeHelper.git", :tag => "1.0.0" }
